...
// 關掉就回到場景曲。主題由使用者從候選試聽裡挑定 shop（其他候選：casino 地下賭場／alchemy 鍊金工房／festival 祭典之夜／musicbox 音樂盒回憶／shop 溫馨小店）。
const GACHA_MUSIC = { theme: 'shop',   // 使用者 2026-09-14 選定：溫馨小店
 gen: { density:60, rhythm:65, speed:60, drama:40, mood:75, hook:80, smooth:55 }, seed: 'gacha-lobby' };
