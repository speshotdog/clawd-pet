window.ClickerStage = (() => {
  function create({ card, sound, format, showRoster, notice, tick }) {
    ...
    return { start, stop, click, render, skill, join, setPartners, freeze, preview, confetti, autoClick, shell, get bossBusy() {return bossBusy;}, get frozen() { return frozen; }, get giftLanded() { return giftLanded; }, get tripleBusy() { return tripleBusy; } };
  }
  return { create };
})();
