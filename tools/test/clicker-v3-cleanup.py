...
with sync_playwright() as p:
    ...
    check(st['v'] == 3 and st['b'] == 13 and st['m'] == 5 and st['L'] and st['L']['blessing'] == 1462, '遷移：v3、祝福 13、印記 5（12 輪 × 8）、legacy 封存 ' + str({k: st[k] for k in ('v','b','m','c')}))
    ...
    check('1,069,453' in body and 'Lv.1,462 → Lv.13' in body and '舊時代的珍母' in body and '魔花少女' in body, '結算內容：保留／整理／補償都在')
