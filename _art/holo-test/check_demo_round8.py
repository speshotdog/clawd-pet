...
def main():
    with sync_playwright() as p:
        ...
        with TemporaryDirectory(prefix='holo-r8-copy-') as tmp:
    ...
    (OUT / 'verification-round8.json').write_text(json.dumps(report, ensure_ascii=False, indent=2), encoding='utf-8')
