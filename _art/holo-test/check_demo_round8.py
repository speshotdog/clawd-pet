...
SHOTS = OUT.parents[1] / 'docs/clicker/shots/round33/retained/demo' / 'round8-shots'
...
def main():
    with sync_playwright() as p:
        ...
        with TemporaryDirectory(prefix='holo-r8-copy-',dir=OUT.parents[1]/'docs/clicker/shots/round33/retained/demo') as tmp:
    ...
    (OUT.parents[1] / 'docs/clicker/shots/round33/retained/demo' / 'verification-round8.json').write_text(json.dumps(report, ensure_ascii=False, indent=2), encoding='utf-8')
