...
def run_team(page, result, out, check, go, freeze, barrier, mask, area, rects, pair, contrast, landmarks, protected_before=None):
    ...
    page.evaluate('team20.reset()');page.evaluate("team20.openPicker('add')");page.locator('#picker-grid .team-proxy[data-id="jintianwoshengri"]').click()
    ...
    page.evaluate("team20.openPicker('skill',1)");page.locator(f'#picker-grid .team-proxy[data-id="{m[1]}"]').click();page.locator('#picker-confirm').click()
    ...
    page.locator('#replace-member').click();page.locator('#picker-grid .team-proxy[data-id="jintianwoshengri"]').click();page.locator('#picker-confirm').click()
    ...
    page.locator('#add-member').click();page.locator(f'#picker-grid .team-proxy[data-id="{removed}"]').click();page.locator('#picker-confirm').click()
