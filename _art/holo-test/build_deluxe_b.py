...
// 2026-09-12 使用者定案（DESIGN-2026-09-12-content-architecture.md §3.2）：神話 0.25%／傳說 4%／史詩 20%／精良 75.75%，沒有普通、沒有保底
const RATE=[['mythic',.0025],['legendary',.04],['epic',.20],['rare',.7575]];
